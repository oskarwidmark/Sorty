...
export class SortingAlgorithms {
  private sortingAlgorithms: Record<SortName, SortAlgorithm> = {
    ...
    [SortName.MergeSort]: this.mergeSort,
...
public async   mergeSort(arr, start, end){
  ...
  */
  ...
  public async mergeSort(arr: SortValue[], options: AlgorithmOptions) {
    switch (options.type) {
      case 'iterative':
        return await this.iterMergeSort(arr);
      case 'recursive':
        return await this.recMergeSort(arr, 0, this.context.columnNbr);
    }
  }
